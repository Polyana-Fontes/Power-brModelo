    ...
    actual fun syncBindingsFromApp(
        ...
        runtime.updateBindings(
            McpUiBindings(
                ...
                onApplyConceptualSpecializationAtTab = onApplyConceptualSpecializationAtTab,
                onApplySimpleConceptualAttributeAtTab = onApplySimpleConceptualAttributeAtTab,
                onApplyCompositeConceptualAttributeAtTab = onApplyCompositeConceptualAttributeAtTab,
                onApplyHiddenAttributeForestAtTab = onApplyHiddenAttributeForestAtTab,
                onLinkConceptualObjectsAtTab = onLinkConceptualObjectsAtTab,
                onApplyEditConceptualModelAtTab = onApplyEditConceptualModelAtTab,
                onApplyEditCanvasElementAtTab = onApplyEditCanvasElementAtTab,
                onApplyEditConnectionAtTab = onApplyEditConnectionAtTab,
                onApplyEditHiddenAttributeAtTab = onApplyEditHiddenAttributeAtTab,
                onApplyOrganizeAttributesMenuAtTab = onApplyOrganizeAttributesMenuAtTab,
                onApplyMoveCanvasElementsAtTab = onApplyMoveCanvasElementsAtTab,
                onConceptualSearchFind = onConceptualSearchFind,
                onConceptualSearchApplyHit = onConceptualSearchApplyHit,
                onEncodeTabConceptualMenuExportPng = onEncodeTabConceptualMenuExportPng,
                onEncodeTabConceptualMenuExportJpeg = onEncodeTabConceptualMenuExportJpeg,
                onEncodeConceptualElementSubsetRaster = onEncodeConceptualElementSubsetRaster,
                onApplyCanvasSelectionRectangleAtTab = onApplyCanvasSelectionRectangleAtTab,
                onSetCanvasSelectionAtTab = onSetCanvasSelectionAtTab,
                onRequestAppWindowFocus = onRequestAppWindowFocus,
                onShowMcpAgentUserNotice = onShowMcpAgentUserNotice,
                onNotifyUser = { msg ->
