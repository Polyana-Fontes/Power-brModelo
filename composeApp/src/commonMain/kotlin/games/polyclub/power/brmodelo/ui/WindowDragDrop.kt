 ...
 * write to JS global variables polled by [games.polyclub.power.brmodelo.ui.isWindowDragActive] and
...
/**
 * Returns and clears a [games.polyclub.power.brmodelo.ui.PickedFile] (name + bytes) for the last file dropped on the
