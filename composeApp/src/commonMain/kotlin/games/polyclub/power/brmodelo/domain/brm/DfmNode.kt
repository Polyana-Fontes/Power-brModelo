 ...
 *
 * The property values are stored as [games.polyclub.power.brmodelo.domain.brm.DfmValue] and helper accessors are provided
...
data class DfmNode(
    ...
    /** Resolves the [games.polyclub.power.brmodelo.domain.ElementPosition] from the standard VCL Left/Top/Width/Height properties. */
    fun position(): ElementPosition =
        ElementPosition(
            x = intProp("Left"),
            y = intProp("Top"),
            width = intProp("Width"),
