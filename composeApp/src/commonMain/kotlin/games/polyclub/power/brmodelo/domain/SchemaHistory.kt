...
/**
 * Undo/redo history for a [games.polyclub.power.brmodelo.domain.ConceptualSchema].
 *
...
class SchemaHistory(initial: ConceptualSchema?) {
    ...
    /**
     * Replaces [current] without pushing an undo checkpoint (e.g. updating [games.polyclub.power.brmodelo.domain.ConceptualSchema.filePath]
