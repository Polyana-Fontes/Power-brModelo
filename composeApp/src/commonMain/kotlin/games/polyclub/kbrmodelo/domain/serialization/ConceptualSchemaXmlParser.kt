...
import games.polyclub.kbrmodelo.domain.xml.XmlNode
import games.polyclub.kbrmodelo.domain.xml.parseXmlBytes

/**
 * Deserializes a brModelo `.xml` file into a [ConceptualSchema].
 *
...
object ConceptualSchemaXmlParser {
    ...
    /**
     * Parses a `<Ligacao>` element and appends a [Connection] to [connections].
     *
    ...
    private fun parsePosition(node: XmlNode) = ElementPosition(
