 ...
 * [ConceptualSchema.elements]. This mirrors the Pascal `OID` / `_Dono` pattern.
 *
...
sealed class SchemaElement {
     ...
     *                             Derived from whether any of its connections has [Connection.isWeak] == true.
     ...
     * node via [Connection] elements (mirroring the ligações on `TEspecializacao`).
     *
    ...
    data class Specialization(
        ...
        /** True when [type] == [SpecializationType.RESTRICTED], same as `TEspecializacao.Restrito`. */
